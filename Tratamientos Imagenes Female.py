...
input_folder = "C:/Users/alvar/OneDrive/Documentos/Universidad/Pruebas/DataAug/Dataset_respaldo/Dataset_respaldo/Female"  # Cambia esto a tu ruta
...
# Ruta de la carpeta con las imágenes
input_folder =  "C:/Users/alvar/OneDrive/Documentos/Universidad/Pruebas/DataAug/Dataset_respaldo/Dataset_respaldo/Female"   # Cambia esto a tu ruta
output_folder = "C:/Users/alvar/OneDrive/Documentos/Universidad/Pruebas/DataAug/Dataset_respaldo/Dataset_rescalado/Female"  # Carpeta de salida
...
xml_folder_path = r"C:\Users\alvar\OneDrive\Documentos\Universidad\Pruebas\DataAug\Dataset_respaldo\Dataset_rescalado\Female"
...
output_csv_path = os.path.join(xml_folder_path, 'images_with_labels_female.csv')  # Guardar en la misma carpeta
...
folder_path = r"C:\Users\alvar\OneDrive\Documentos\Universidad\Pruebas\DataAug\Dataset_respaldo\Dataset_rescalado\Female"
csv_path = os.path.join(folder_path, 'images_with_labels_female.csv')
...
output_folder = r"C:\Users\alvar\OneDrive\Documentos\Universidad\Pruebas\DataAug\Dataset_respaldo\Dataset_solución\female"
os.makedirs(output_folder, exist_ok=True)
...
resized_csv_path = os.path.join(output_folder, 'resized_images_with_labels_female.csv')
...
folder_path = r"C:\Users\alvar\OneDrive\Documentos\Universidad\Pruebas\DataAug\Dataset_respaldo\Dataset_solución\female"
csv_path = os.path.join(folder_path, 'resized_images_with_labels_female.csv')
